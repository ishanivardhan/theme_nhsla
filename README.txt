...
This document describes how to copy and customise the NHSLA (clean) theme so that
...
From your Moodle theme directory right click on nhsla and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of nhsla.
...
underscores. For the purpose of this tutorial we will call the theme 'nhslatheme'.

On opening 'nhslatheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case nhsla. So using the above list as
a guide, search through and change all the instances of the theme name
'nhsla' to 'nhslatheme'. This includes the filename of the lang/en/theme_nhsla.php.
You need to change this to 'theme_nhslatheme.php'.
...
and then click on (NHSLAtheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the NHSLA theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > NHSLA

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/NHSLA_theme
